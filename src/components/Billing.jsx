    ...
    <section id='product' className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          ...
          Dolor sed laudantium eius itaque deleniti! Adipisci perspiciatis 
          facere sint incidunt obcaecati inventore magnam, fugit, 
        </p>

        <div className='flex flex-row flex-wrap sm:mt-10 mt-6'>
          <img src={apple} alt="apple_store" className='w-[128px] h-[42px] 
          object-contain mr-5 cursor-pointer'/>
          <img src={google} alt="google_pay" className='w-[128px] h-[42px] 
